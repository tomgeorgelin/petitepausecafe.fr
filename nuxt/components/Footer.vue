<template>
	<footer
		class="md:h-[100px] flex flex-row justify-evenly bg-white pt-3 items-center"
		:class="isContentShort ? 'fixed bottom-0 w-full' : ''"
	>
		...
		<div class="w-1/3 text-center">
			Copyright - petitepausecafe.fr - 2023
		</div>
	</footer>
</template>
...
export default {
	...
	methods: {
		checkContentHeight() {
			...
			this.isContentShort = contentHeight <= windowHeight;
		},
	},
};
</script>
